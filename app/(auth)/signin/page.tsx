      ...
      >
        <div className="flex flex-col gap-5 sm:gap-6 md:gap-8">
          ...
          <motion.div
            ...
            className="bg-white/[0.03] backdrop-blur-2xl rounded-3xl p-5 sm:p-6 md:p-7 lg:p-8 border border-white/10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] relative overflow-hidden group"
          >
