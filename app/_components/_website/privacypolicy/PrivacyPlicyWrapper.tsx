          ...
          >
            ...
            <section id="rights" className="scroll-mt-32 mb-12">
              ...
              <div className="flex flex-col gap-4 text-gray-300 leading-relaxed ml-4">
                ...
                <p>
                  <strong className="text-gray-200">5.3 Opt-Out:</strong> You
            ...
            <section id="children" className="scroll-mt-32 mb-12">
              ...
              <div className="flex flex-col gap-4 text-gray-300 leading-relaxed ml-4">
                <p>
                  ...
                  inadvertently collected such data, we will take steps to
                  delete it promptly. Parents who believe we may have collected
            ...
            <section id="transfers" className="scroll-mt-32 mb-12">
              ...
              <div className="flex flex-col gap-4 text-gray-300 leading-relaxed ml-4">
                <p>
                  ...
                  in your jurisdiction. We ensure that appropriate safeguards
            ...
            <section id="changes" className="scroll-mt-32 mb-12">
              ...
              <div className="flex flex-col gap-4 text-gray-300 leading-relaxed ml-4">
                <p>
                  ...
                  notify you through a prominent notice on our website or via
